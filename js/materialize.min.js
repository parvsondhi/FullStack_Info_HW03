...
$(document).ready(
    $("#new-item").on('click', function() {
        ...
        $('#list_todo').prepend("<div class='card-panel white' id='item-user-input'> <a class='btn-floating btn-small waves-effect waves-light blue'><i class='material-icons'>check</i></a>" + user_input + "</div>");
    })
);

$("#list_todo").on('click', "a", function() {
